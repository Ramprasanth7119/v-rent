...
export const originalDataProvider: ReportDataProvider = {
  ...
  dataset: {
    ...
    badge: MARKET_SOURCE.live ? null : 'Illustrative data',
  },
  ...
  wording: {
    verified: 'Verified',
    datasetBadge: MARKET_SOURCE.live ? 'Verified' : 'Illustrative',
    datasetDetail: MARKET_SOURCE.live ? MARKET_SOURCE.publisher : 'Demonstration data in URA format, not live URA data',
    shortNote: 'Illustrative dataset: the URA contract feed is not yet connected.',
  ...
  position: (l) => marketPosition(l, TRANSACTIONS),
  history: (l) => marketHistory(l, TRANSACTIONS),
